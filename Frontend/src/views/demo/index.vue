            ...
            <ul class="nav nav-sm flex-column">
              <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarSignIn">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                      <router-link to="/login" class="nav-link" data-key="t-signin">{{ $t("t-signin") }}
                      </router-link>
                    </li>
                  </ul>
                </div>
              ...
              <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarResetPass">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                      <router-link to="/auth/reset-pwd" class="nav-link" data-key="t-password-reset">
                        {{ $t("t-password-reset") }}
                      </router-link>
                    </li>
                  </ul>
              ...
              <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarLogout">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                      <router-link to="/auth/logout" class="nav-link" data-key="t-cover">
                        {{ $t("t-cover") }}
                      </router-link>
                    </li>
                  </ul>
              ...
              <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarErrors">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                      <router-link to="/error/404" class="nav-link" data-key="t-404-alt">
                        {{ $t("t-404-alt") }}
                      </router-link>
                    </li>
                    <li class="nav-item">
                      <router-link to="/error/500" class="nav-link" data-key="t-500">
                        {{ $t("t-500") }}
                      </router-link>
                    </li>
                    <li class="nav-item">
                      <router-link to="/error/offline" class="nav-link" data-key="t-offline-page">
                        {{ $t("t-offline-page") }}
                      </router-link>
                    </li>
                  </ul>
